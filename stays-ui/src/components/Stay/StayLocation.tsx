        ...
        <Grid container spacing={3}>
          <Grid item xs={12}>
            <TextField
              ...
              onChange={(e) => {
                stay.location.address.address1 = e.target.value;
              }}
            />
          </Grid>
          <Grid item xs={12}>
            <TextField
              ...
              onChange={(e) => {
                stay.location.address.address2 = e.target.value;
              }}
            />
          </Grid>
          <Grid item xs={12} sm={6}>
            <TextField
              ...
              onChange={(e) => {
                stay.location.address.city = e.target.value;
              }}
            />
          </Grid>
          <Grid item xs={12} sm={6}>
            <TextField
              ...
              onChange={(e) => {
                stay.location.address.state = e.target.value;
              }}
            />
          </Grid>
          <Grid item xs={12} sm={6}>
            <TextField
              ...
              onChange={(e) => {
                stay.location.address.zip = Number(e.target.value);
              }}
            />
          </Grid>
          <Grid item xs={12} sm={6}>
            <TextField
              ...
              onChange={(e) => {
                stay.location.address.country = e.target.value;
              }}
            />
          </Grid>
        </Grid>

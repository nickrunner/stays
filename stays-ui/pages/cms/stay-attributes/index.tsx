...
export default function StayAttributesCms(props: StayAttributeCmsProps) {
  ...
  const [selectedStayAttribute, setSelectedStayAttribute] = React.useState<
    StayAttributeRecord | undefined
  >(undefined);
          ...
          <Grid container spacing={3}>
            ...
            <Grid item xs={12} md={8} lg={9}>
              <Paper
                ...
                <StayAttributesTable
                  type={props.type}
                  stayAttributes={stayAttributes}
                  onSelect={handleStayAttributeSelection}
                />
              </Paper>
            </Grid>
